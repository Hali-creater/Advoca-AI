...
1.  **Open `index.html` in a web browser.**
    -   You can do this by simply double-clicking the `index.html` file.
2.  **Interact with the receptionist.**
    -   You can type your message in the input box and click "Send" or press Enter.
    -   Alternatively, you can click the microphone icon (🎤) to use voice commands. You may need to grant microphone permissions to your browser.
